...
type TimeClient interface {
	GetTime(ctx context.Context, in *ServerTime, opts ...grpc.CallOption) (*ReturnTime, error)
}
...
func (c *timeClient) GetTime(ctx context.Context, in *ServerTime, opts ...grpc.CallOption) (*ReturnTime, error) {
	out := new(ReturnTime)
	err := c.cc.Invoke(ctx, "/currency.Time/GetTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TimeServer interface {
	GetTime(context.Context, *ServerTime) (*ReturnTime, error)
...
func (UnimplementedTimeServer) GetTime(context.Context, *ServerTime) (*ReturnTime, error) {
...
func _Time_GetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/currency.Time/GetTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeServer).GetTime(ctx, req.(*ServerTime))
	}
